...
console.log(firstNonRepeatingLetter("a"), "should be 'a'");
console.log(firstNonRepeatingLetter("stress"), "should be 't'");
console.log(firstNonRepeatingLetter("sTreSS"), "should be 'T'");
console.log(firstNonRepeatingLetter("moonmen"), "should be 'e'");
